...
export class Printer {
    ...
    constructor() {
        this.getPrinter().then(printer => {
            this.printer = printer
            this.getEndpoints(printer).then((endpoints) => (this.endpoints = endpoints));
        });
    }
     ...
     */
    private async getEndpoints(printer: USBDevice): Promise<Record<USBEndpoint['direction'], USBEndpoint>> {
